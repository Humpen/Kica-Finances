package de.nbl.kica.finances.views.main;
...
import de.nbl.kica.finances.views.about.AboutView;
import de.nbl.kica.finances.views.helloworld.HelloWorldView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "KiCa Finances", shortName = "KiCa Finances",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/KiCa-Transparent.png", "KiCa Finances logo"));
        logoLayout.add(new H1("KiCa Finances"));
